defmodule CashFlow.Accounts do
  @moduledoc """
  ...
  alias CashFlow.Accounts.{User, UserToken, UserNotifier}
  ...
  See `CashFlow.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `CashFlow.Accounts.User.password_changeset/3` for a list of supported options.
