defmodule CashFlowWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CashFlowWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CashFlowWeb.Gettext, "errors", msg, opts)
    end
  end
